...
model = pickle.load(open('models/lr_model_2_balanced.pkl', 'rb'))
...
def Drafter():
    ...
    while node.state.terminal_state() is False:
        ...
        pick_red = MonteCarlo.uctSearch(TIME_LIMIT, node, 'red')    # Run MCTS om een champion te krijgen voor red-side
